...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token', models.CharField(default='bff634e12c064825b81ba7bcb0f83d2f', max_length=30)),
                ('creation_date', models.CharField(default=datetime.time(16, 58, 52, 111850), max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(default=datetime.datetime(2019, 4, 7, 16, 58, 52, 110922))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messages', models.ManyToManyField(to='codev_app.Message')),
            ],
        ),
        migrations.AddField(
            model_name='user',
